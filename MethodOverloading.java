public class MethodOverloading {
    ...
    static void change1(int x){ // number gets copied
        x=55;
    }
    static void change2(int [] marks){ // reference gets copied
        marks[0]=55;
    }
    public static void main(String[] args) {
        ...
        change2(marks); // now we are passing the reference or address of the object we created
